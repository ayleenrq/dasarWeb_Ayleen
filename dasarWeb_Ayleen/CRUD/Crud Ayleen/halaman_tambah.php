...
if(isset($_POST["tombol_submit"])) {
    $tambahDataEvent = tambahDataEvent($_POST);
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto" style="gap: 2rem;">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="#">Tambah Acara</a>
                    </li>
                </ul>  
            </div>
        </div>
                ...
                <div class="card-body">
                    <form method="POST" action="">
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="labelNama" name="field_nama" required>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="labelDeskripsi" class="col-sm-2 col-form-label">Deskripsi</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="labelDeskripsi" name="field_deskripsi" required>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="labelTanggal" class="col-sm-2 col-form-label">Tanggal</label>
                            <div class="col-sm-10">
                                <input type="date" class="form-control" id="labelTanggal" name="field_tanggal" required>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="labelWaktu" class="col-sm-2 col-form-label">Jam</label>
                            <div class="col-sm-10">
                                <input type="time" class="form-control" id="labelWaktu" name="field_waktu" required>
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="labelLokasi" class="col-sm-2 col-form-label">Lokasi</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="labelLokasi" name="field_lokasi" required>
                            </div>
                        </div>
